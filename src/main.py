...
def get_args():
    ...
    trainp.add_argument("--save-every", type=int, default=1, help="Save model every n epochs.")
    trainp.add_argument("--batch-size", type=int, default=4, help="Batch size.")
    trainp.add_argument("--batch-step", type=int, default=32, help="Number of batches per step.")
    trainp.add_argument("--lr", type=float, default=1e-3, help="Learning rate.")
    trainp.add_argument("--weight-decay", type=float, default=1e-5, help="Weight decay.")
    trainp.add_argument("--data-workers", type=int, default=6, help="Number of data workers.")
    trainp.add_argument("--resume", type=int, default=-1, help="Resume from this session, last epoch.")
    trainp.add_argument("--train-split", type=float, default=0.9, help="Train/test split.")
